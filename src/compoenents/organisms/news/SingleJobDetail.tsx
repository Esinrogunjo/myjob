...
const SingleJobDetail = ({ job }: any) => {
  ...
  return (
    <div className=" mb-[3.75rem] mx-auto rounded-[0.625rem] border-[#8B8B8B] border-[0.5px] flex flex-col w-[78.5625rem]  pb-[2.125rem]">
      ...
      <div className="mx-[2.4375rem] flex justify-between mt-[6.75rem] font-medium text-xl leading-[1.875rem]">
        <Button
          ...
          className="bg-baseText text-[#00717D] border-[#00717D] border-[1px] w-[19.65rem] h-[3.75rem]"
        />
        <Button
          label="Share"
          className="bg-baseText text-[#00717D] border-[#00717D] border-[1px] w-[19.65rem] h-[3.75rem]"
        ...
        <Button
          label="Apply"
          className="bg-primary text-baseText border-[#00717D] border-[1px] w-[19.65rem] h-[3.75rem]"
        />
      </div>
    </div>
  );
